...
void Shader3DShadowMap::Init( void )
{
	...
	hr = D3DXCompileShaderFromFile( "HLSL/3D/shadowMapVS.hlsl" ,		//  ファイル名
									NULL ,								//  
									NULL ,								//  
	...
	hr = D3DXCompileShaderFromFile( "HLSL/3D/shadowMapPS.hlsl" ,			//  ファイル名
									NULL ,								//  
									NULL ,								//  
									"main" ,							//  エントリー関数名( 一番初めに行われる関数 )
									"ps_3_0" ,							//  シェーダモデル名
...
//  シェーダー描画に必要な情報の設定
//--------------------------------------------------------------------------------------
void Shader3DShadowMap::SetShaderInfo( const D3DXMATRIX &worldMatrix , const D3DXMATRIX &lightViewProjectionMatrix )
{
